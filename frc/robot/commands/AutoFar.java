...
public class AutoFar extends Command {
  ...
  public AutoFar(Drivetrain drive, ShooterArmHandler shootarm, ShooterHandler shoot, Alliance color) {
  ...
  public void stageTwo() {
    ...
    if (setTime) {
      ...
      if (team == Alliance.Red) {
        drivetrain.driveTank(-0.85, 0.35, 0, true);
